...
CREATE OR REPLACE FUNCTION "public"."send_notification_email"(notif_id bigint, sales_id bigint, notif_type text, payload jsonb) RETURNS void
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
    DECLARE
...
CREATE OR REPLACE FUNCTION "public"."merge_two_contacts"("p_winner" bigint, "p_loser" bigint) RETURNS void
    LANGUAGE "plpgsql"
    SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
...
CREATE OR REPLACE FUNCTION "public"."dedupe_contacts_by_phone"("p_max" integer DEFAULT 200) RETURNS "jsonb"
    LANGUAGE "plpgsql"
    SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
